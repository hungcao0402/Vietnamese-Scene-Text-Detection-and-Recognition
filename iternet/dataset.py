...
class ImageDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.case_sensitive, self.is_training = True, is_training
    ...
    def __getitem__(self, idx):
       ...
       #if not self.is_training: assert idx == idx_new, f'idx {idx} != idx_new {idx_new} during testing. {text} - {len(text)}'
        ...
        label = self.charset.get_labels(text, case_sensitive=True)
...
class TextDataset(Dataset):
    def __init__(self,
                 ...
                 **kwargs):
        self.path = Path(path)
        self.case_sensitive, self.use_sm = True, use_sm
    ...
    def __getitem__(self, idx):
        ...
        label_x = self.charset.get_labels(text_x, case_sensitive=True)
        ...
        label_y = self.charset.get_labels(text_y, case_sensitive=True)
